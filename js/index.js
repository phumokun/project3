angular.module('forcedirectedApp', [])
  .directive('forcedirectedChart', function() {
    ...
    $scope.mcuSimple = [{source:"วิทยาเขตปัตตานี", sourceType: "Character",target:"Prince of Songkla University", targetType: "Movie",type:"Main"},
      ...
      {source:"วิทยาเขตหาดใหญ่", sourceType: "Character",target:"บัณฑิตวิทยาลัย", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตหาดใหญ่", sourceType: "Character",target:"คณะวิทยาศาสตร์", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตหาดใหญ่", sourceType: "Character",target:"คณะวิศวกรรมศาสตร์", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตหาดใหญ่", sourceType: "Character",target:"คณะทรัพยากรธรรมชาติ", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตหาดใหญ่", sourceType: "Character",target:"คณะอุตสาหกรรมเกษตร", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตหาดใหญ่", sourceType: "Character",target:"คณะการจัดการสิ่งแวดล้อม", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตหาดใหญ่", sourceType: "Character",target:"คณะแพทยศาสตร์", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตหาดใหญ่", sourceType: "Character",target:"คณะพยาบาลศาสตร์", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตหาดใหญ่", sourceType: "Character",target:"วิทยาลัยนานาชาติ", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตหาดใหญ่", sourceType: "Character",target:"คณะทันตแพทยศาสตร์", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตหาดใหญ่", sourceType: "Character",target:"คณะเภสัชศาสตร์", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตหาดใหญ่", sourceType: "Character",target:"คณะวิทยาการจัดการ", targetType: "Movie",type:"Side"},
      ...
      {source:"วิทยาเขตปัตตานี", sourceType: "Character",target:"คณะศึกษาศาสตร์", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตปัตตานี", sourceType: "Character",target:"คณะมนุษยศาสตร์และสังคมศาสตร์", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตปัตตานี", sourceType: "Character",target:"คณะวิทยาศาสตร์และเทคโนโลยี", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตปัตตานี", sourceType: "Character",target:"คณะศิลปกรรมศาสตร์", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตปัตตานี", sourceType: "Character",target:"คณะวิทยาการสื่อสาร", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตปัตตานี", sourceType: "Character",target:"คณะรัฐศาสตร์", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตปัตตานี", sourceType: "Character",target:"วิทยาลัยอิสลามศึกษา", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตปัตตานี", sourceType: "Character",target:"คณะพยาบาลศาสตร์", targetType: "Movie",type:"Side"},

      {source:"วิทยาเขตภูเก็ต", sourceType: "Character",target:"คณะการบริการและการท่องเที่ยว", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตภูเก็ต", sourceType: "Character",target:"คณะเทคโนโลยีและสิ่งแวดล้อม", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตภูเก็ต", sourceType: "Character",target:"คณะวิศวกรรมศาสตร์", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตภูเก็ต", sourceType: "Character",target:"คณะวิเทศศึกษา", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตภูเก็ต", sourceType: "Character",target:"วิทยาลัยชุมชนภูเก็ต", targetType: "Movie",type:"Side"},

      {source:"วิทยาเขตสุราษฎร์ธานี", sourceType: "Character",target:"คณะวิทยาศาสตร์และเทคโนโลยีอุตสาหกรรม", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตสุราษฎร์ธานี", sourceType: "Character",target:"คณะศิลปศาสตร์และวิทยาการจัดการ", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตสุราษฎร์ธานี", sourceType: "Character",target:"วิทยาลัยชุมชนสุราษฎร์ธานี", targetType: "Movie",type:"Side"},

      {source:"วิทยาเขตตรัง", sourceType: "Character",target:"คณะพาณิชยศาสตร์และการจัดการ", targetType: "Movie",type:"Side"},
      {source:"วิทยาเขตตรัง", sourceType: "Character",target:"คณะสถาปัตยกรรมศาสตร์", targetType: "Movie",type:"Side"},
